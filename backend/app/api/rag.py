...
async def upload_file(
    ...
    return await RAGService.upload_file(file=file, collection=collection, user=user, _=_)
...
async def query_documents(
    ...
    return await RAGService.query_documents(query=request.query, collection=collection, user=user)
